...
interface BlogPostDocumentData {
  ...
  /**
   * Link to Article field in *Blog Post*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: blog_post.link_to_source
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  link_to_source: prismic.LinkField;
...
interface ProjectDocumentData {
  ...
  /**
   * Link to Project field in *Project*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project.link_to_source
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  link_to_source: prismic.LinkField;
