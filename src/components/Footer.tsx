...
export default async function Footer() {
  ...
  return (
    <Bounded as="footer" className="text-slate-600 lg:pb-0 lg:pt-5">
      <div className="container mx-auto mt-20 flex flex-col items-center justify-between gap-6 py-8 sm:flex-row md:mt-4 md:pt-0 ">
