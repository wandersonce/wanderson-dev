...
export default async function Footer() {
  ...
  return (
    <Bounded as="footer" className="text-slate-600 lg:pt-5 lg:pb-0">
      <div className="container mx-auto mt-20 flex flex-col items-center justify-between gap-6 py-8 md:pt-0 md:mt-4 sm:flex-row ">
